class AiDanceVideoGenTask:
    ...
    def __init__(self, id=None, dance_video_id=None, model_image_id=None, clothes_image_id=None,
                 image_gen_config_id=None, model_gen_config_id=None, video_gen_config_id=None,
                 ai_clothes_id=None, dressed_model_id=None, new_video_id=None,
                 submitted_at=None, status=None, result_desc=None):
        self.id = id
        self.dance_video_id = dance_video_id
    ...
    def to_dict(self):
        return {
            'id': self.id,
            'dance_video_id': self.dance_video_id,
    ...
    def from_dict(cls, data):
        return cls(
            id=data.get('id'),
            dance_video_id=data.get('dance_video_id'),
    ...
    def get_status_display(self):
        status_map = {
            ...
            self.STATUS_VIDEO_GENERATED: '已生成新视频',
