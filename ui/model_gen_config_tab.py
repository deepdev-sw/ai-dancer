...
class ModelGenConfigTab(QWidget):
    ...
    def init_ui(self):
        ...
        self.type_combo.addItem(ModelGenConfig.CONFIG_TYPE_VOLC_ENGINE)
    ...
    def add_config(self):
        ...
        dialog = ModelConfigEditDialog(self, name=name, config_type=config_type)
        if dialog.exec_() == QDialog.Accepted:
            try:
                self.db_manager.add_model_gen_config(name, config_type, dialog.get_config_content())
    ...
    def edit_config(self, config_id, name, config_type, config_content):
        ...
        if dialog.exec_() == QDialog.Accepted:
            try:
                self.db_manager.update_model_gen_config(config_id, dialog.name_input.text().strip(), 
    ...
    def delete_config(self, config_id):
        ...
        if reply == QMessageBox.Yes:
            try:
                self.db_manager.delete_model_gen_config(config_id)
                self.load_data()
...
class ModelConfigEditDialog(QDialog):
    def __init__(self, parent=None, name='', config_type='', config_content=''):
        ...
        self.parent = parent
        self.setWindowTitle('编辑新模特图片生成配置')
